      ...
      <div className="container w-4/5 md:w-1/2 m-auto lg:mx-auto  lg:w-1/3 border-1 box-border mt-[4rem] lg:mt-[10rem] ">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="Otp_input flex justify-center ">
            <input
              type="number"
              className=" mx-2 outline-none w-10 border-[0.1rem] border-[#6A52FD] rounded-md py-2 text-center bg-[#F6F4FF] "
              autoFocus
              name="otpotp"
              id=""
              {...register("otp", { required: true, maxLength: 1 })}
            />
            <input
              type="number"
              className="mx-2 outline-none w-10 border-[0.1rem] border-[#6A52FD] rounded-md py-2 text-center bg-[#F6F4FF] "
            ...
            <input
              type="number"
              className="mx-2 outline-none border-[0.1rem] border-[#6A52FD] w-10  rounded-md py-2 text-center bg-[#F6F4FF] "
              name="otp"
              id=""
              {...register("otp", { required: true, maxLength: 1 })}
            />
