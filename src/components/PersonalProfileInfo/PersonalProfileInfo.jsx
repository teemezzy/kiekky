...
import {
  personalProfile,
  reset,
} from "../../Redux/features/personalProfile/personalProfileSlice";
    ...
    <div className=" flex mt-10  w-[326px] lg:w-[984px]  ">
      <div className=" lg:w-[984px] w-[326px] ">
        {profile.map((profiles, id) => (
          <div key={id} className="story-status   rounded-xl bg-white ">
            <div className="">
              <div className=" w-[284px] lg:w-[892px] m-auto">
                  ...
                  <div className="lg:w-[42rem] mt-[1rem] sm:w-[17rem] md:w-[23rem] ml-5">
                    ...
                    <div className="buttons mt-9 text-sm space-x-5 space-y-7 pb-4  hidden lg:block">
                      <NavLink to="/edit_profile">
                        ...
                        <button
                          className=" w-[8rem] text-sm  lg:w-[8rem] px-2 lg:px-6 py-[0.6rem] bg-[#6a52fd] text-white rounded-lg "
                          type="submit"
                        >
                          Edit Profile
                        </button>
                      ...
                      <NavLink to="/share">
                        <button
                          className=" w-[5rem] text-sm lg:text-base lg:w-[8rem] lg:px-6 py-[7px] text-[#6a52fd] border-[1px] border-[#6a52fd] rounded-lg "
                          type="submit"
                        >
                          Share
                        </button>{" "}
                ...
                <div className="buttons flex items-center justify-center  py-[2rem] space-x-5 lg:space-y-7   lg:hidden block">
                  <NavLink to="/edit_profile">
                    {" "}
                    <button
                      className=" w-[130px] h-[42px] bg-[#6a52fd] text-white rounded-lg "
                      type="submit"
                    >
                      Edit Profile
                    </button>{" "}
                  ...
                  <NavLink to="/share">
                    {" "}
                    <button
                      className=" w-[130px] h-[42px] text-[#6a52fd] border-[1px] border-[#6a52fd] rounded-lg "
                      type="submit"
                    >
                      Share
                    </button>{" "}
