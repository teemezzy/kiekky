...
const SendRequestTokenModal = ({ visible, onClose }) => {
  ...
  return (
    <div className=" bg-opacity-60 inset-0 m-auto">
      <div className="w-[251px] border-2 h-[200px] right-9 bottom-0  bg-white flex flex-col justify-center items-center absolute">
        <div className="bg-white">
          ...
          <div className=" w-[130px] m-auto">
            ...
            <button onClick={handleRequestTokenModal} className="bg-[#6A52FD] text-white py-[14px] px-[24px] rounded-lg text-[12px] mt-[26px]">
              Request Token
            </button>
          </div>
        </div>
