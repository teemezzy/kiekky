        ...
        ? feed.map((feed, idx) => (
            ...
            >
              <div className="icons flex justify-between">
                ...
                <span onClick={() => setShowMyBlock(true)}>
                  {" "}
              ...
              <div className="pic-not mt-4 flex gap-2 items-start pt-4  ">
                ...
                <div className="lg:w-[42rem] w-[17rem]  lg:pt-[1rem] ml-[15px] md:w-[23rem]">
                  ...
                  <div className="icons flex  space-x-3 mt-4">
                    ...
                    <span className="text-xs text-[#828282] ">4</span>
                    <p className="text-sm text-[#828282] ">
                      {" "}
                      <FiVideo color="" />
                    </p>{" "}
                    <span className="text-xs text-[#828282]">2</span>
                  </div>

                  <div className="buttons mt-6 text-sm space-x-5 space-y-7  pb-4 hidden lg:block">
                    <button
                      onClick={() => setShowMyModal(true)}
                      className=" w-[8rem] text-xs lg:text-base lg:w-[8rem] px-2 lg:px-6 py-[0.4rem] bg-[#6a52fd] text-white rounded-lg "
                      type="submit"
                    >
                      Open Chat
                    </button>
