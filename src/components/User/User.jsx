...
function User() {
  ...
  return (
    <div className="flex flex-col mt-10 lg:w-[984px] w-[347px] h-[246px]">
      {feed
        ? feed.map((feed, idx) => (
            <div
              key={idx}
              className="story-status px-[18px] lg:px-[64px] bg-white py-4 lg:w-[984px] w-[347px] "
            >
                ...
                <div className="lg:w-[42rem] w-[17rem] md:w-[23rem]">
                  ...
                  <div className="buttons mt-6 text-sm space-x-5 space-y-7 pb-4">
                    <button
                      ...
                      className=" w-[8rem] text-xs lg:text-base lg:w-[8rem] px-1 lg:px-6 py-[0.4rem] bg-[#6a52fd] text-white rounded-lg"
                      type="submit"
                    >
                      Open Chat
                    </button>
                    <NavLink to="/subscribe">
                      <button
                        className=" w-[5rem] text-xs lg:text-base lg:w-[8rem] lg:px-6 py-1 text-[#6a52fd] border-[1px] border-[#6a52fd] rounded-lg "
                        type="submit"
                      >
                        Subscribe
                      </button>
