...
<div className="postItem  items-center mb-7 ">
  <div className="username flex items-center mx-5 ">
    ...
    <img className='mb-2 w-[4rem] h-[4rem]  p-[1.5px] border-red-500 border-2 rounded-[50%] cursor-pointer hover:scale-110 transition transform duration-200 ease-out' src={feed.image} alt="icon" />
...
<div className="post-img h-[9rem] md:h-[10rem] flex  mx-5">
  <img className='mr-5 w-[10rem] lg:w-[16rem]' src={feed.image} alt="" />
