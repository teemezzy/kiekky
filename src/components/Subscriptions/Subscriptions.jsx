...
const Subscriptions = () => {
  return (
    <div className="w-[984px] m-auto">
      <div className="flex md:flex-row flex-col justify-center m-auto mt-[157px]">
        <div className="w-[260px] bg-[#F6F4FF] pl-[25px] rounded-lg">
          ...
          <button onClick={() =>{} } className='bg-[#6A52FD] text-white py-[17.5px] px-[77.5px] mt-[42px] mb-[27px]'>Choose</button>
        </div>

        <div className="w-[260px] bg-[#6A52FD] rounded-lg text-white pl-[25px] ">
          <div className="flex items-center justify-around mt-[29px]">
            <p className=" font-extrabold text-[32px] ">1000</p>
            <p className="text-[12px] py-[5px] px-[8px] bg-white text-[#8645FF] rounded-md">Save 400</p>
          </div>
          ...
          <button onClick={() =>{} } className='bg-white text-[#6A52FD] py-[17.5px] px-[77.5px] mt-[42px]' >Choose</button>
        </div>
