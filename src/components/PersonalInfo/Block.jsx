...
function Block({ visibleBlock, onCloseBlock }) {
    ...
    return (
        <div className='fixed  '>
            <div className="fixed lg:h-[10rem] lg:w-[14rem] w-[251px] h-[185px] shadow lg:top-48 top-[27rem] right-6 lg:left-0 lg:right-12 m-auto z-20 py-3  rounded-lg bg-white">
