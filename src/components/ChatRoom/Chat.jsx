    ...
    <div className="w-[490px] flex flex-col justify-start">
      <div className="bg-white divide-y divide-opacity-50 divide-gray-300">
        <div className=' w-[423px] m-auto relative py-[27px]' >
          <input type="text" placeholder='Search in messages...' className=' py-[14px] px-[20px] pr-[60px] border-2 rounded-lg text-[14px] bg-[#F6F4FF] w-[423px] '/> 
          ...
          <div key={chat.id} className="">
            ...
            >
              ...
              <div className="flex items-center pl-6 pt-[30px] ">
                ...
                <div className=" ">
                  <span>{chat.name}</span>
                  <div className="w-[289px] m-auto mb-4  ">{chat.lastMessage}</div>
                </div>
              </div>
            </NavLink>
          </div>
