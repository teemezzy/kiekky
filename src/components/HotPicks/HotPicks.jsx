...
function HotPicks() {
  ...
  const url = "https://fakerapi.it/api/v1/books?_quantity=28";
      ...
      <div className=" flex justify-between lg:w-[968px]">
        <div className=" space-x-2 flex items-center">
          ...
          <div className="flex space-x-[1px] bg-[#F6F4FF] ">
            <p className=" text-xs  text-[#999999] py-1 rounded-md ">
              Gender:
            </p>
            <select
              className="outline-none text-xs  w-[4rem] text-[#999999] bg-[#F6F4FF] "
              name=""
              id=""
            >
              <option
                className="outline-none hover:bg-[#6a52fd]  border-none"
                value="Male"
              >
                Male
              </option>
              <option
                className="outline-none hover:bg-[#6a52fd]"
                value="Male"
              >
                Female
              </option>
        ...
        <NavLink to="/view_all">
          {" "}
          <p className="view text-sm text-[#6a52fd] ">
            View all <span> {`${">>"}`}</span>
          </p>{" "}
        </NavLink>
      </div>
                  ...
                  <div key={idx} className="story-status object-cover ">
                    <div className=" relative">
                      <div className=" absolute  inset-x-0 bottom-0 bg-opacity-70 names w-[100px] lg:w-[154px] h-[30px] bg-[#A8A8A8] rounded-b-md ">
                        <p className=" text-center truncate py-[3px]  text-white">
                          {story.author}{" "}
